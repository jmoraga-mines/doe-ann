#!/bin/env bash
#SBATCH --job-name=paper_brady_27x7_07        # Job name
...
#SBATCH --output=paper_brady_27x7_07_%j.log   # Standard output and error log
...
then
   ...
   echo "python geoai_spcv.py -a -c 7 -d brady_ai_stack.grd -k 27 -b 200 -e 200 -l ../doe-data/brady_27x3d200.07.l -m ../doe-data/brady_27x7d200.07.h5 -g 4 -s 100000  -i 07 -r"
   time(python geoai_spcv.py -a -c 7 -d brady_ai_stack.grd -k 27 -b 200 -e 200 -l ../doe-data/brady_27x3d200.07.l -m ../doe-data/brady_27x7d200.07.h5 -g 4 -s 100000  -i 07 -r)
else
