...
then
   ...
   echo "python geoai_spcv.py -a -c 7 -d brady_ai_stack.grd -k 27 -b 200 -e 200 -l ../doe-data/brady_27x3d200.13.l -m ../doe-data/brady_27x7d200.13.h5 -g 4 -s 100000  -i 13 -r"
   time(python geoai_spcv.py -a -c 7 -d brady_ai_stack.grd -k 27 -b 200 -e 200 -l ../doe-data/brady_27x3d200.13.l -m ../doe-data/brady_27x7d200.13.h5 -g 4 -s 100000  -i 13 -r)
else
