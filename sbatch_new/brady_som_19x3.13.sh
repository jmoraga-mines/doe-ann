#!/bin/env bash
#SBATCH --job-name=paper_brady_19.3.13        # Job name
...
#SBATCH --output=paper_brady_19_3_13_%j.log   # Standard output and error log
...
then
   ...
   echo "../doe-data/brady_som_output.grd"
   echo "python geoai_spcv.py -a -c 3 -d ../doe-data/brady_som_output.grd -k 19 -b 200 -e 100 -l ../doe-data/brady_19x3d100.13.l -m ../doe-data/brady_19x3d100.13.h5 -g 4 -s 200000  -i 13 -r"
   time(python geoai_spcv.py -a -c 3 -d ../doe-data/brady_som_output.grd -k 19 -b 200 -e 100 -l ../doe-data/brady_19x3d100.13.l -m ../doe-data/brady_19x3d100.13.h5 -g 4 -s 200000  -i 13 -r)
else
