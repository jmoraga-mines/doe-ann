...
def inception_m( input_net, first_layer = None, prefix = None ):
    prefix = str(prefix or '') # Convert prefix to string, replaces None for empty string
    ...
    inception_t1_3x3 = Conv2D(128, (3,3), padding='same', activation = 'relu', kernel_regularizer = l2(0.002), name=prefix+"i_3x3")(inception_t1_3x3_reduce)
    inception_t1_5x5_reduce = Conv2D(16, (1,1), padding='same', activation = 'relu', kernel_regularizer = l2(0.002))(conv1)
    inception_t1_5x5 = Conv2D(128, (5,5), padding='same', activation = 'relu', kernel_regularizer = l2(0.002), name=prefix+"i_5x5")(inception_t1_5x5_reduce)
    inception_t1_7x7_reduce = Conv2D(16, (1,1), padding='same', activation = 'relu', kernel_regularizer = l2(0.002))(conv1)
    inception_t1_7x7 = Conv2D(128, (7,7), padding='same', activation = 'relu', kernel_regularizer = l2(0.002), name=prefix+"i_7x7")(inception_t1_7x7_reduce)
    inception_t1_9x9_reduce = Conv2D(16, (1,1), padding='same', activation = 'relu', kernel_regularizer = l2(0.002))(conv1)
    inception_t1_9x9 = Conv2D(64, (7,7), padding='same', activation = 'relu', kernel_regularizer = l2(0.002), name=prefix+"i_9x9")(inception_t1_9x9_reduce)
    inception_t1_11x11_reduce = Conv2D(16, (1,1), padding='same', activation = 'relu', kernel_regularizer = l2(0.002))(conv1)
    inception_t1_11x11 = Conv2D(64, (7,7), padding='same', activation = 'relu', kernel_regularizer = l2(0.002), name=prefix+"i_11x11")(inception_t1_11x11_reduce)
    inception_t1_13x13_reduce = Conv2D(16, (1,1), padding='same', activation = 'relu', kernel_regularizer = l2(0.002))(conv1)
    inception_t1_13x13 = Conv2D(64, (7,7), padding='same', activation = 'relu', kernel_regularizer = l2(0.002), name=prefix+"i_13x13")(inception_t1_13x13_reduce)
    inception_t1_15x15_reduce = Conv2D(16, (1,1), padding='same', activation = 'relu', kernel_regularizer = l2(0.002))(conv1)
    inception_t1_15x15 = Conv2D(64, (7,7), padding='same', activation = 'relu', kernel_regularizer = l2(0.002), name=prefix+"i_15x15")(inception_t1_15x15_reduce)
...
if __name__ == '__main__':
    ...
    if (reset_model or not model_exist):
        ...
        inception_01 = inception_m( my_input, prefix = 'j01_' )
        inception_02 = inception_m( inception_01, prefix = 'j02_' )
        inception_03 = inception_m( inception_02, first_layer = my_input, prefix = 'j03_')
        # Attaches end to inception modules, returns class within num_classes
        loss3_classifier_act = inception_m_end( inception_03,
