...
then
   ...
   time(python doe_ann_map.py -c 3 -k 19 -b 200 -l tmp/brady_19x3d100.l -m tmp/brady_19x3d100.h5 -g 4 -i ../doe-data/brady_som_output.gri -p paper_results/brady_19x3d100.npy -o paper_results/brady_19x3d100.gri)
else
