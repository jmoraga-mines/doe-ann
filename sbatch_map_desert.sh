#!/bin/env bash
#SBATCH --job-name=paper_desert_map       # Job name
...
#SBATCH --output=paper_desert_map_%j.log   # Standard output and error log
...
then
   ...
   time(python doe_ann_map.py -c 3 -k 19 -b 200 -l tmp/desert_19x3d100.l -m tmp/desert_19x3d100.h5 -g 4 -i ../doe-data/desert_som_output.gri -p paper_results/desert_19x3d100.npy -o paper_results/desert_19x3d100.gri)
else
